...
import { Megaphone, Search, AlertTriangle, CalendarDays, User } from "lucide-react";
      ...
      <div className="p-4 sm:p-6">
        ...
        {selected ? (
          <Card className="p-6 border-primary/20 animate-fadeUp">
            <button onClick={() => setSelected(null)} className="text-sm text-muted-foreground hover:text-foreground mb-4 flex items-center gap-1">
              ← Back to list
            </button>
            ...
            <h2 className="text-xl font-bold text-foreground mb-4">{selected.title}</h2>
            ...
            <div className="text-foreground leading-relaxed whitespace-pre-wrap">{selected.content}</div>
          </Card>
        ) : (
