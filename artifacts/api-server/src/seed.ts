...
async function seed() {
  ...
  // Users (residents + officials for login)
  ...
  await db.insert(ordinances).values([
    {
      id: "ORD-001", number: "BO-2026-001",
      title: "AN ORDINANCE REGULATING NOISE POLLUTION IN BARANGAY SANTIAGO",
      type: "Ordinance", dateEnacted: "2026-01-15", author: "Hon. Rolando C. Borja", status: "Active",
    ...
    {
      id: "ORD-002", number: "BRes-2026-001",
      title: "RESOLUTION AUTHORIZING THE BARANGAY CAPTAIN TO ENTER INTO A MEMORANDUM OF AGREEMENT",
      type: "Resolution", dateEnacted: "2026-01-28", author: "Barangay Council", status: "Active",
    ...
    {
      id: "ORD-003", number: "BO-2025-012",
      title: "AN ORDINANCE ESTABLISHING A BARANGAY SCHOLARSHIP PROGRAM",
      type: "Ordinance", dateEnacted: "2025-11-10", author: "Hon. Ana Maria Reyes", status: "Active",
  ...
  await db.insert(projects).values([
    { id: "PRJ-001", title: "Feeding Program 2026", description: "Monthly feeding program for malnourished children and senior citizens in all puroks.", category: "Health & Nutrition", status: "ongoing", startDate: "2026-01-15", endDate: "2026-12-15", location: "All Puroks", budget: "150000", actualCost: "45000", leadBy: "Kap. Rolando C. Borja", beneficiaries: 120, requirements: ["Food supplies", "Volunteer coordinators", "Venue setup"], milestones: [{ name: "Program Launch", date: "2026-01-15", status: "completed" }, { name: "Q1 Distribution", date: "2026-03-31", status: "completed" }, { name: "Q2 Distribution", date: "2026-06-30", status: "pending" }], fundSource: "Barangay Development Fund" },
    { id: "PRJ-002", title: "Road Rehabilitation - Purok 3", description: "Repair and improvement of damaged roads in Purok 3 Bonifacio.", category: "Infrastructure", status: "planning", startDate: "2026-05-01", endDate: "2026-07-31", location: "Purok 3 - Bonifacio", budget: "500000", actualCost: "0", leadBy: "Coun. Jose L. Reyes", beneficiaries: 350, contractor: "JMRC Construction", contractorContact: "0912-234-5678", requirements: ["DPWH Clearance", "Environmental Compliance Certificate"], milestones: [{ name: "Planning & Design", date: "2026-04-30", status: "completed" }, { name: "Procurement", date: "2026-05-15", status: "pending" }], fundSource: "20% Development Fund" },
    { id: "PRJ-003", title: "Livelihood Training: Handicrafts", description: "Skills training for unemployed residents in handicraft production for income generation.", category: "Livelihood", status: "completed", startDate: "2026-02-01", endDate: "2026-03-31", location: "Barangay Hall", budget: "80000", actualCost: "72000", leadBy: "Coun. Ana Maria Reyes", beneficiaries: 45, requirements: ["Training materials", "Resource speakers"], milestones: [{ name: "Registration", date: "2026-02-01", status: "completed" }, { name: "Training Sessions", date: "2026-03-15", status: "completed" }, { name: "Certification", date: "2026-03-31", status: "completed" }], fundSource: "TESDA Grant" },
    { id: "PRJ-004", title: "Basketball Court Renovation", description: "Renovation and improvement of the barangay basketball court with new flooring and lighting.", category: "Sports & Recreation", status: "ongoing", startDate: "2026-03-01", endDate: "2026-04-30", location: "Covered Court, Santiago", budget: "200000", actualCost: "120000", leadBy: "Coun. Mark Santos", beneficiaries: 800, contractor: "BrightBuild Corp", contractorContact: "0923-456-7890", requirements: ["Building permit", "Electrical permit"], milestones: [{ name: "Design & Planning", date: "2026-03-01", status: "completed" }, { name: "Floor Works", date: "2026-03-31", status: "completed" }, { name: "Lighting Installation", date: "2026-04-20", status: "pending" }], fundSource: "Barangay Development Fund" },
  ]);
  ...
  await db.insert(assets).values([
    { id: "AST-001", name: "Barangay Multi-Purpose Vehicle", category: "Vehicle", description: "Toyota Hi-Ace Van for community transport and emergency use", acquisitionDate: "2022-06-15", acquisitionCost: "1200000", condition: "Good", location: "Barangay Hall Garage", accountableOfficer: "Hon. Rolando C. Borja", serialNumber: "TAV-2022-001" },
    { id: "AST-002", name: "Desktop Computer Set", category: "IT Equipment", description: "Office computer with complete peripherals for records management", acquisitionDate: "2023-01-10", acquisitionCost: "45000", condition: "Excellent", location: "Barangay Hall Office", accountableOfficer: "Sec. Maria D. Santos", serialNumber: "CPU-2023-001", warranty: "2025-01-10" },
    { id: "AST-003", name: "Generator Set (10KVA)", category: "Equipment", description: "Emergency power generator for barangay hall", acquisitionDate: "2021-08-20", acquisitionCost: "85000", condition: "Fair", location: "Barangay Hall Basement", accountableOfficer: "Hon. Rolando C. Borja", serialNumber: "GEN-2021-001" },
