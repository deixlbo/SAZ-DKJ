      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-border shadow-lg p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-foreground">Official Login</h1>
            <p className="text-muted-foreground text-sm mt-2">Authorized officials only</p>
          </div>
          ...
          <div className="mt-4 p-3 bg-primary/10 rounded-lg border border-primary/20 text-center">
            <p className="text-xs text-primary font-medium">
              Demo: captain@brgy-santiago.gov.ph / any password (4+ chars)
            </p>
          </div>
        </div>
      </div>
